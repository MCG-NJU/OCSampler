...
def train_model(model,
    ...
    if cfg.get('adjust_parameters', None):
        from ..core.hooks.adjust_parameters import ParamAdjusterHook
        param_adjust_hook = ParamAdjusterHook(**cfg.adjust_parameters)
        runner.register_hook(param_adjust_hook)
        
    if cfg.get('tau_parameters', None):
        from ..core.hooks.gumbel_parameters import TauAdjusterHook
        tau_adjust_hook = TauAdjusterHook(**cfg.tau_parameters)
        runner.register_hook(tau_adjust_hook)
