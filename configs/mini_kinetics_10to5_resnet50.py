...
data_root = 'data/mini_kinetics/rawframes_train'
data_root_val = 'data/mini_kinetics/rawframes_val'
ann_file_train = 'data/mini_kinetics/mini_kinetics_train.txt'
ann_file_val = 'data/mini_kinetics/mini_kinetics_val.txt'
ann_file_test = 'data/mini_kinetics/mini_kinetics_val.txt'
